...
public class OrderLineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2286107569365862053L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderLineItem\",\"namespace\":\"avro.schema.generated\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"size\",\"type\":{\"type\":\"enum\",\"name\":\"Size\",\"symbols\":[\"SMALL\",\"MEDIUM\",\"LARGE\"]}},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"cost\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":3,\"scale\":2}}]}");
...
static {
  ...
  @Deprecated public avro.schema.generated.Size size;
   ...
   */
  public OrderLineItem(java.lang.CharSequence name, avro.schema.generated.Size size, java.lang.Integer quantity, java.math.BigDecimal cost) {
    this.name = name;
    this.size = size;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: size = (avro.schema.generated.Size)value$; break;
   ...
   */
  public avro.schema.generated.Size getSize() {
    return size;
  }
   ...
   * @param value the value to set.
   */
  public void setSize(avro.schema.generated.Size value) {
    this.size = value;
  }
   ...
   */
  public static avro.schema.generated.OrderLineItem.Builder newBuilder() {
    return new avro.schema.generated.OrderLineItem.Builder();
  }
   ...
   * @return A new OrderLineItem RecordBuilder
   */
  public static avro.schema.generated.OrderLineItem.Builder newBuilder(avro.schema.generated.OrderLineItem.Builder other) {
    if (other == null) {
      return new avro.schema.generated.OrderLineItem.Builder();
    } else {
      return new avro.schema.generated.OrderLineItem.Builder(other);
    }
  }
   ...
   * @return A new OrderLineItem RecordBuilder
   */
  public static avro.schema.generated.OrderLineItem.Builder newBuilder(avro.schema.generated.OrderLineItem other) {
    if (other == null) {
      return new avro.schema.generated.OrderLineItem.Builder();
    } else {
      return new avro.schema.generated.OrderLineItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderLineItem>
    ...
    private avro.schema.generated.Size size;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.schema.generated.OrderLineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro.schema.generated.OrderLineItem other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.generated.OrderLineItem.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.generated.OrderLineItem.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.generated.OrderLineItem.Builder setSize(avro.schema.generated.Size value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.generated.OrderLineItem.Builder clearSize() {
      size = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.generated.OrderLineItem.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.generated.OrderLineItem.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.generated.OrderLineItem.Builder setCost(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.generated.OrderLineItem.Builder clearCost() {
      cost = null;
    ...
    public OrderLineItem build() {
      try {
        ...
        record.size = fieldSetFlags()[1] ? this.size : (avro.schema.generated.Size) defaultValue(fields()[1]);
