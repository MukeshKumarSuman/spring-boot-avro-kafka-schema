...
public class OrderId extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7238445243411141313L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderId\",\"namespace\":\"avro.schema.generated\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}}]}");
...
static {
   ...
   */
  public OrderId(java.util.UUID id) {
    this.id = id;
  }
   ...
   */
  public static avro.schema.generated.OrderId.Builder newBuilder() {
    return new avro.schema.generated.OrderId.Builder();
  }
   ...
   * @return A new OrderId RecordBuilder
   */
  public static avro.schema.generated.OrderId.Builder newBuilder(avro.schema.generated.OrderId.Builder other) {
    if (other == null) {
      return new avro.schema.generated.OrderId.Builder();
    } else {
      return new avro.schema.generated.OrderId.Builder(other);
    }
  }
   ...
   * @return A new OrderId RecordBuilder
   */
  public static avro.schema.generated.OrderId.Builder newBuilder(avro.schema.generated.OrderId other) {
    if (other == null) {
      return new avro.schema.generated.OrderId.Builder();
    } else {
      return new avro.schema.generated.OrderId.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderId>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.schema.generated.OrderId.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro.schema.generated.OrderId other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.generated.OrderId.Builder setId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.generated.OrderId.Builder clearId() {
      id = null;
