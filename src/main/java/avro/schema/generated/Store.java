...
public class Store extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public avro.schema.generated.Address address;
   ...
   */
  public Store(java.lang.Integer id, avro.schema.generated.Address address) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: address = (avro.schema.generated.Address)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public avro.schema.generated.Address getAddress() {
    return address;
  }
   ...
   * @param value the value to set.
   */
  public void setAddress(avro.schema.generated.Address value) {
    this.address = value;
  }
   ...
   */
  public static avro.schema.generated.Store.Builder newBuilder() {
    return new avro.schema.generated.Store.Builder();
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static avro.schema.generated.Store.Builder newBuilder(avro.schema.generated.Store.Builder other) {
    if (other == null) {
      return new avro.schema.generated.Store.Builder();
    } else {
      return new avro.schema.generated.Store.Builder(other);
    }
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static avro.schema.generated.Store.Builder newBuilder(avro.schema.generated.Store other) {
    if (other == null) {
      return new avro.schema.generated.Store.Builder();
    } else {
      return new avro.schema.generated.Store.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Store>
    ...
    private int id;
    private avro.schema.generated.Address address;
    private avro.schema.generated.Address.Builder addressBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(avro.schema.generated.Store.Builder other) {
      super(other);
      ...
      if (other.hasAddressBuilder()) {
        this.addressBuilder = avro.schema.generated.Address.newBuilder(other.getAddressBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(avro.schema.generated.Store other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.generated.Store.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.generated.Store.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.generated.Store.Builder setAddress(avro.schema.generated.Address value) {
     ...
     * @return This builder.
     */
    public avro.schema.generated.Address.Builder getAddressBuilder() {
      if (addressBuilder == null) {
        if (hasAddress()) {
          setAddressBuilder(avro.schema.generated.Address.newBuilder(address));
        } else {
          setAddressBuilder(avro.schema.generated.Address.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public avro.schema.generated.Store.Builder setAddressBuilder(avro.schema.generated.Address.Builder value) {
      clearAddress();
    ...
    /**
      ...
      * @return This builder.
      */
    public avro.schema.generated.Store.Builder clearAddress() {
      address = null;
      addressBuilder = null;
    ...
    public Store build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[1] ? this.address : (avro.schema.generated.Address) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.address == null) {
        this.address = new avro.schema.generated.Address();
      }
